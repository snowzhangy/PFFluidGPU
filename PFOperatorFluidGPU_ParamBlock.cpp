/**********************************************************************
 *<
	FILE:			PFOperatorFluidGPU_ParamBlock.cpp
...
PFOperatorFluidGPUDesc ThePFOperatorSimpleSpeedDesc;
...
(
	...
	// required param specs
		...
		// viscosity
			kpFlowFuild_viscosity,	_T("Viscosity"),
									TYPE_WORLD,
									P_ANIMATABLE | P_RESET_DEFAULT,
									IDS_VISCOSITY,
			// optional tagged param specs
					...
					p_range,		-999999999.f, 999999999.f,
					p_ui,			TYPE_SPINNER, EDITTYPE_UNIVERSE,
									IDC_VISCOSITY, IDC_VISCOSITYSPIN, SPIN_AUTOSCALE,
			end,
		// diffusion
			kpFlowFuild_diffusion,	_T("Diffusion"),
									TYPE_WORLD,
									P_ANIMATABLE | P_RESET_DEFAULT,
									IDS_DIFFUSION,
			// optional tagged param specs
					...
					p_range,		-999999999.f, 999999999.f,
					p_ui,			TYPE_SPINNER, EDITTYPE_UNIVERSE,
									IDC_DIFFUSION, IDC_DIFFUSIONSPIN, SPIN_AUTOSCALE,
			end,
			// mass
			kpFlowFuild_mass,	_T("MASS"),
									TYPE_WORLD,
									P_ANIMATABLE | P_RESET_DEFAULT,
									IDS_MASS,
			// optional tagged param specs
					...
					p_range,		-999999999.f, 999999999.f,
					p_ui,			TYPE_SPINNER, EDITTYPE_UNIVERSE,
									IDC_MASS, IDC_MASSSPIN, SPIN_AUTOSCALE,
			end,
			// temperature
			kpFlowFuild_temperature,	_T("Temperture"),
									TYPE_WORLD,
									P_ANIMATABLE | P_RESET_DEFAULT,
									IDS_TEMPER,
			// optional tagged param specs
					...
					p_range,		-999999999.f, 999999999.f,
					p_ui,			TYPE_SPINNER, EDITTYPE_UNIVERSE,
									IDC_TEMPER, IDC_TEMPERSPIN, SPIN_AUTOSCALE,
			end,
			// direction
			kpFlowFuild_direction,	_T("Direction"),
									TYPE_INT,
									0,
									IDS_DIRECTION,
			// optional tagged param specs
		...
		// reverse
			kpFlowFuild_reverse,	_T("Reverse"),
									TYPE_BOOL,
									P_RESET_DEFAULT,
									IDS_REVERSE,
			// optional tagged param specs
		...
		// divergence
			kpFlowFuild_divergence,_T("Divergence"),
									TYPE_ANGLE,
									P_ANIMATABLE | P_RESET_DEFAULT,
									IDS_DIVERGENCE,
			// optional tagged param specs
		...
		// seed
			kpFlowFuild_seed,		_T("Random_Seed"),
									TYPE_INT,
									P_RESET_DEFAULT,
									IDS_RANDOMSEED,
			// optional tagged param specs
		...
		case WM_COMMAND:
			switch(LOWORD(wParam)) {
				case IDC_DIRECTION:
					...
					break;
				case IDC_NEW:
					map->GetParamBlock()->NotifyDependents(FOREVER, PART_OBJ, kpFlowFuild_RefMsg_NewRand);
					break;
				case IDC_CLEANSIM:
					map->GetParamBlock()->NotifyDependents(FOREVER, PART_OBJ, kpFlowFuild_RefMsg_CleanSim);
					break;
			}
			break;
	}
